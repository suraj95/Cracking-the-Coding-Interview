...
Reference template: https://www.codesdope.com/blog/article/c-linked-lists-in-c-singly-linked-list/
...
void linked_list::add_node(int n){
    ...
    if(tmp == NULL){
        ...
        /*
            ...
            when tmp is NULL. The author in the reference template had used a tail pointer to keep track of the tail of the linkled list 
